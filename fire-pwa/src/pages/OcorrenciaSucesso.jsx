      ...
      <div className="scrollContent">
        <div className="content">
          ...
          <div className="buttonContainer">
            <button className="button primaryButton" onClick={handleInicio}>
              Início
            </button>
            <button className="button secondaryButton" onClick={handleListarOcorrencias}>
              Listar Ocorrências
            </button>
            <button className="button accentButton" onClick={handleNovaOcorrencia}>
              Registrar Nova Ocorrência
            </button>
            <button className="button pdfButton" onClick={handleExportarPDF}>
